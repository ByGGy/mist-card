...
console.log('2. Create a new Godot project in the apps/playground directory.');
console.log('3. Set up the basic project structure and scenes.');
console.log('4. Write initial scripts for handling card data and game rules.');